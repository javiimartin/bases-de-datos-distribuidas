...
DROP TABLE PRODUCTOR1;
DROP TABLE EMPLEADO1;
DROP TABLE CLIENTE1; 
DROP TABLE SUMINISTRO1;
DROP TABLE PEDIDO1;
DROP TABLE PIDEVINOA;
DROP TABLE VINO1;
DROP TABLE SUCURSAL1;
ALTER TABLE SUCURSAL1 DROP CONSTRAINT CE9;
...
DELETE FROM SUCURSAL1 WHERE CODSU>1;
DELETE FROM EMPLEADO1 WHERE CODEM>1;
UPDATE SUCURSAL1 SET CODDIRECTOR=NULL WHERE CODSU=4;
UPDATE SUCURSAL1 SET CODDIRECTOR=NULL WHERE CODSU=5;
UPDATE SUCURSAL1 SET CODDIRECTOR=NULL WHERE CODSU=6;
...
GRANT SELECT, INSERT, DELETE, UPDATE ON SUCURSAL1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON PRODUCTOR1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON VINO1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON EMPLEADO1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON CLIENTE1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON PEDIDO1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON SUMINISTRO1 TO kdekilo2, kdekilo3, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON PIDEVINOA TO kdekilo2, kdekilo3, kdekilo4;
...
INSERT INTO SUCURSAL1 VALUES(4, 'ALmudena', 'Madrid', 'Madrid', NULL);
INSERT INTO SUCURSAL1 VALUES(5, 'El Cid', 'Burgos', 'Castilla-Leon', NULL);
INSERT INTO SUCURSAL1 VALUES(6, 'Puente La Reina', 'Logroño', 'La Rioja', NULL);


INSERT INTO EMPLEADO1 VALUES(7, 4, '77777777G', 'Agustín', TO_DATE('05-MAY-2014', 'DD-MON-YYYY'), 2000, 'Pablo Neruda 84, Madrid');
INSERT INTO EMPLEADO1 VALUES(8, 4, '88888888H', 'Eduardo', TO_DATE('06-JUN-2014', 'DD-MON-YYYY'), 1800, 'Alcala 8, Madrid');
INSERT INTO EMPLEADO1 VALUES(9, 5, '99999999I', 'Alberto', TO_DATE('05-SEP-2015', 'DD-MON-YYYY'), 2000, 'Las Huelgas 15, Burgos');
INSERT INTO EMPLEADO1 VALUES(10, 5, '10101010J', 'Soraya', TO_DATE('04-OCT-2012', 'DD-MON-YYYY'), 1800, 'Jimena 2, Burgos');
INSERT INTO EMPLEADO1 VALUES(11, 6, '01010101K', 'Manuel', TO_DATE('06-JUL-2011', 'DD-MON-YYYY'), 2000, 'Estrella 26, Logroño');
INSERT INTO EMPLEADO1 VALUES(12, 6, '12121212L', 'Emilio', TO_DATE('05-NOV-2013', 'DD-MON-YYYY'), 1800, 'Constitucion, Logroño');

-- Actualizamos los directores de las sucursales
UPDATE SUCURSAL1 SET CODDIRECTOR=7 WHERE CODSU=4;
UPDATE SUCURSAL1 SET CODDIRECTOR=9 WHERE CODSU=5;
UPDATE SUCURSAL1 SET CODDIRECTOR=11 WHERE CODSU=6;
UPDATE SUCURSAL1 SET CODDIRECTOR=7 WHERE CODSU=6;

SELECT * FROM EMPLEADO1;


INSERT INTO VINO1 VALUES(1, 'Vega Sicilia', 2003, 'Ribera del Duero', 12.5, 'Castillo Blanco', 200, 200, 'Castilla-Leon', NULL);
INSERT INTO VINO1 VALUES(2, 'Vega Sicilia', 2010, 'Ribera del Duero', 12.5, 'Castillo Blanco', 100, 100, 'Castilla-Leon', NULL);
INSERT INTO VINO1 VALUES(3, 'Marques de Caceres', 2014, 'Rioja', 11, 'Santo Domingo', 200, 200, 'La Rioja', NULL);
INSERT INTO VINO1 VALUES(4, 'Marques de Caceres', 2017, 'Rioja', 11.5, 'Santo Domingo', 250, 250, 'La Rioja', NULL);
INSERT INTO VINO1 VALUES(17, 'Estela', 2017, 'Cariñena', 10.5, 'San Millan', 200, 200, 'Aragon', NULL);
INSERT INTO VINO1 VALUES(14, 'Tablas de Daimiel', 2013, 'Valdepeñas', 11.5, 'Laguna Azul', 300, 300, 'Castilla-La Mancha', NULL);


INSERT INTO PRODUCTOR1 VALUES(1, '35353535A','Justiniano Briñon', 'Ramon y Cajal 9, Valladolid');
INSERT INTO PRODUCTOR1 VALUES(2, '36363636B','Marcelino Peña', 'San Francisco 7, Pamplona');
INSERT INTO PRODUCTOR1 VALUES(3, '37373737C','Paloma Riquelme', 'Antonio Gaudi 23, Barcelona');
INSERT INTO PRODUCTOR1 VALUES(5, '39393939E','Ramon Esteban', 'Gran Via de Colon 121, Madrid');

UPDATE VINO1 SET CODPR=1 WHERE CODVIN=1;
UPDATE VINO1 SET CODPR=1 WHERE CODVIN=2;
UPDATE VINO1 SET CODPR=2 WHERE CODVIN=3;
UPDATE VINO1 SET CODPR=2 WHERE CODVIN=4;
UPDATE VINO1 SET CODPR=3 WHERE CODVIN=17;
UPDATE VINO1 SET CODPR=5 WHERE CODVIN=14;

SELECT * FROM VINO1;

INSERT INTO CLIENTE1 VALUES(7, '32323232G', 'Restaurante Candido', 'Acueducto 1, Segovia', 'C', 'Castilla-León');
INSERT INTO CLIENTE1 VALUES(8, '34343434H', 'Las Vidrieras', 'Cervantes 16, Almagro', 'C', 'Castilla-La Mancha');

INSERT INTO SUMINISTRO1 VALUES(7, 1, 4, 80, TO_DATE('15-FEB-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO1 VALUES(7, 7, 5, 50, TO_DATE('17-ABR-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO1 VALUES(7, 10, 4, 70, TO_DATE('21-JUN-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO1 VALUES(7, 12, 5, 40, TO_DATE('23-JUL-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO1 VALUES(8, 14, 6, 50, TO_DATE('11-ENE-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO1 VALUES(8, 4, 6, 60, TO_DATE('14-MAR-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO1 VALUES(8, 6, 4, 70, TO_DATE('21-MAY-2023', 'DD-MON-YYYY'));
...
BEFORE UPDATE OF SALARIO ON EMPLEADO1
FOR EACH ROW
BEGIN
...
BEFORE INSERT ON SUMINISTRO1
FOR EACH ROW
DECLARE
    ultimaFechaSuministro DATE;
BEGIN
    -- Obtener la fecha del último suministro para este cliente
    SELECT MAX(FECHASUMINISTRO) INTO ultimaFechaSuministro FROM SUMINISTRO1 WHERE CODCL = :NEW.CODCL;
...
BEGIN
    ...
    SELECT SUM(CANTIDAD) INTO totalSuministrado FROM SUMINISTRO1 WHERE CODVIN = :OLD.CODVIN;
...
BEGIN
    ...
    FROM VINO1 V
    JOIN SUMINISTRO1 S ON V.CODVIN = S.CODVIN
...
CREATE OR REPLACE PROCEDURE AltaNuevoEmpleado
    (NEW_CODEM INT, NEW_DNI IN EMPLEADO1.DNI%TYPE, NEW_NOMBRE IN EMPLEADO1.NOMBRE%TYPE, NEW_FECHACONTRATO DATE, NEW_SALARIO INT,
    NEW_DIRECCION IN EMPLEADO1.DIRECCION%TYPE, NEW_CODSU INT)
IS 
    nSucursales INT;
    nEmpleados INT;
    comAutSucursal SUCURSAL1.COMAUTONOMA%TYPE; 
BEGIN
    ...
    ELSE
        ...
        CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                INSERT INTO EMPLEADO1 VALUES(NEW_CODEM, NEW_CODSU, NEW_DNI, NEW_NOMBRE, NEW_FECHACONTRATO, NEW_SALARIO, NEW_DIRECCION);
...
BEGIN
    AltaNuevoEmpleado(2, '91919191A', 'Magnolia', TO_DATE('2020-01-02', 'YYYY-MM-DD'), 1700, 'La Marina 23, La Coruña', 10);
END;
...
BEGIN
    ...
    ELSE
        ...
        CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                DELETE FROM EMPLEADO1 WHERE CODEM=OLD_CODEM;
            WHEN (comAutSucursal = 'Cataluña' OR comAutSucursal = 'Baleares' OR comAutSucursal = 'Pais Valenciano' OR comAutSucursal = 'Murcia') THEN
...
BEGIN
    ...
    ELSE
        ...
        CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                UPDATE EMPLEADO1 SET SALARIO = NEW_SALARIO WHERE CODEM = NEW_CODEM;
...
BEGIN
    ModificarSalarioEmpleado(1, 1800);
END;
...
CREATE OR REPLACE PROCEDURE TrasladarEmpleadoSucursal
    (NEW_CODEM INT, NEW_CODSU INT, NEW_DIRECCION IN EMPLEADO1.DIRECCION%TYPE DEFAULT NULL)
IS 
    nEmpleados INT;
    nSucursal INT;
    comAutSucursal SUCURSAL1.COMAUTONOMA%TYPE; 
    FCONTRATO DATE;
    SUELDO INT;
    NEW_DNI EMPLEADO1.DNI%TYPE;
    NEW_NOMBRE EMPLEADO1.NOMBRE%TYPE;
BEGIN
    SELECT COUNT(*) INTO nEmpleados FROM EmpleadoView WHERE CODEM = NEW_CODEM;
...
CREATE OR REPLACE PROCEDURE AltaNuevaSucursal
    (NEW_CODSU IN SUCURSAL1.CODSU%TYPE, NEW_NOMBRE IN SUCURSAL1.NOMBRE%TYPE, NEW_CIUDAD IN SUCURSAL1.CIUDAD%TYPE, NEW_COMAUTONOMA IN SUCURSAL1.COMAUTONOMA%TYPE,
    ...
    ELSE
        CASE
            WHEN (NEW_COMAUTONOMA = 'Castilla-Leon' OR NEW_COMAUTONOMA = 'Castilla-La Mancha' OR NEW_COMAUTONOMA = 'Aragon' OR NEW_COMAUTONOMA = 'Madrid' OR NEW_COMAUTONOMA = 'La Rioja') THEN
                INSERT INTO SUCURSAL1 VALUES(NEW_CODSU, NEW_NOMBRE, NEW_CIUDAD, NEW_COMAUTONOMA, NEW_CODDIRECTOR);
...
INSERT INTO SUCURSAL1 VALUES(123, 'sucursal', 'ciudad', 'Andalucia', 123);
...
BEGIN
    ...
    ELSE        
        ...
        CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                UPDATE SUCURSAL1 SET CODDIRECTOR = NEW_CODDIRECTOR WHERE CODSU = NEW_CODSU;
            WHEN (comAutSucursal = 'Cataluña' OR comAutSucursal = 'Baleares' OR comAutSucursal = 'Pais Valenciano' OR comAutSucursal = 'Murcia') THEN
...
CREATE OR REPLACE PROCEDURE AltaNuevoCliente
    (NEW_CODCL INT, NEW_DNI IN CLIENTE1.DNI%TYPE, NEW_NOMBRE IN CLIENTE1.NOMBRE%TYPE, NEW_DIRECCION IN CLIENTE1.DIRECCION%TYPE,
    NEW_TIPO IN CLIENTE1.TIPO%TYPE, NEW_COMAUTONOMA IN CLIENTE1.COMAUTONOMA%TYPE)
IS 
    nCliente INT;
BEGIN
    ...
    ELSE
        CASE
            WHEN (NEW_COMAUTONOMA = 'Castilla-Leon' OR NEW_COMAUTONOMA = 'Castilla-La Mancha' OR NEW_COMAUTONOMA = 'Aragon' OR NEW_COMAUTONOMA = 'Madrid' OR NEW_COMAUTONOMA = 'La Rioja') THEN
                INSERT INTO CLIENTE1 VALUES(NEW_CODCL, NEW_DNI, NEW_NOMBRE, NEW_DIRECCION, NEW_TIPO, NEW_COMAUTONOMA);
            WHEN (NEW_COMAUTONOMA = 'Cataluña' OR NEW_COMAUTONOMA = 'Baleares' OR NEW_COMAUTONOMA = 'Pais Valenciano' OR NEW_COMAUTONOMA = 'Murcia') THEN
...
BEGIN
    AltaNuevoCliente(9, '71717171N', 'Alcampo', 'San Bartolome 5, Soria', 'D', 'Castilla-Leon');
END;

SELECT * FROM ClienteView;
DELETE FROM CLIENTE1 WHERE CODCL=123;
...
BEGIN
    ...
    IF nSuministros > 0 THEN -- hay que actualizar el suministro
         CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                UPDATE SUMINISTRO1 SET CANTIDAD = CANTIDAD + NEW_CANTIDAD WHERE CODCL = NEW_CODCL AND CODVIN = NEW_CODVIN AND CODSU = NEW_CODSU AND FECHASUMINISTRO = NEW_FECHA;
            WHEN (comAutSucursal = 'Cataluña' OR comAutSucursal = 'Baleares' OR comAutSucursal = 'Pais Valenciano' OR comAutSucursal = 'Murcia') THEN
    ...
    ELSE -- hay que crear el suministro
        CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                INSERT INTO SUMINISTRO1 VALUES(NEW_CODCL, NEW_CODVIN, NEW_CODSU, NEW_CANTIDAD, NEW_FECHA);
            WHEN (comAutSucursal = 'Cataluña' OR comAutSucursal = 'Baleares' OR comAutSucursal = 'Pais Valenciano' OR comAutSucursal = 'Murcia') THEN
...
BEGIN
    ActualizarSuministro(6, 7, 21, TO_DATE('17-SEP-2023', 'DD-MON-YYYY'), 50);
END;
...
BEGIN
    ...
    ELSE 
        CASE
            WHEN (comAutSucursal = 'Castilla-Leon' OR comAutSucursal = 'Castilla-La Mancha' OR comAutSucursal = 'Aragon' OR comAutSucursal = 'Madrid' OR comAutSucursal = 'La Rioja') THEN
                DELETE FROM SUMINISTRO1 WHERE CODCL = NEW_CODCL AND CODVIN = NEW_CODVIN AND CODSU = NEW_CODSU AND (NEW_FECHA IS NULL OR FECHASUMINISTRO = NEW_FECHA);
            WHEN (comAutSucursal = 'Cataluña' OR comAutSucursal = 'Baleares' OR comAutSucursal = 'Pais Valenciano' OR comAutSucursal = 'Murcia') THEN
...
BEGIN
    CrearPedidoSucursal(7, 2, 21, TO_DATE('15-SEP-2023', 'DD-MON-YYYY'), 50);
END;
...
CREATE OR REPLACE PROCEDURE AltaNuevoVino
    (NEW_CODVIN INT, NEW_MARCA IN VINO1.MARCA%TYPE, NEW_ANIOCOSECHA INT, NEW_DENOMINACION IN VINO1.DENOMINACION_ORIGEN%TYPE, NEW_GRADUACION IN VINO1.GRADUACION%TYPE,
    NEW_VINIEDO IN VINO1.VINIEDOPROCEDENCIA%TYPE, NEW_COMAUTONOMA IN VINO1.COMAUTONOMA%TYPE, NEW_CANTPRODUCIDA INT, NEW_CODPR INT)
IS 
    nVino INT;
BEGIN
    ...
    ELSE
        CASE
            WHEN (NEW_COMAUTONOMA = 'Castilla-Leon' OR NEW_COMAUTONOMA = 'Castilla-La Mancha' OR NEW_COMAUTONOMA = 'Aragon' OR NEW_COMAUTONOMA = 'Madrid' OR NEW_COMAUTONOMA = 'La Rioja') THEN
                INSERT INTO VINO1 VALUES(NEW_CODVIN, NEW_MARCA, NEW_ANIOCOSECHA, NEW_DENOMINACION, NEW_GRADUACION, NEW_VINIEDO, NEW_CANTPRODUCIDA, NEW_CANTPRODUCIDA, 
...
IS 
    nVino INT;
    comAutonomaVino VINO1.COMAUTONOMA%TYPE;
BEGIN
    SELECT COUNT(*) INTO nVino FROM VinoView WHERE CODVIN = NEW_CODVIN;
    ...
    ELSE
        CASE
            WHEN (comAutonomaVino = 'Castilla-Leon' OR comAutonomaVino = 'Castilla-La Mancha' OR comAutonomaVino = 'Aragon' OR comAutonomaVino = 'Madrid' OR comAutonomaVino = 'La Rioja') THEN
                DELETE FROM VINO1 WHERE CODVIN = NEW_CODVIN;
...
CREATE OR REPLACE PROCEDURE AltaNuevoProductor
    (NEW_CODPR INT, NEW_DNI IN PRODUCTOR1.DNI%TYPE, NEW_NOMBRE IN PRODUCTOR1.NOMBRE%TYPE, NEW_DIRECCION IN PRODUCTOR1.DIRECCION%TYPE)
IS 
    nProductor INT;
BEGIN
    SELECT COUNT(*) INTO nProductor FROM ProductorView WHERE CODPR = NEW_CODPR;
    ...
    ELSE
        ...
        INSERT INTO PRODUCTOR1 VALUES(NEW_CODPR, NEW_DNI, NEW_NOMBRE, NEW_DIRECCION);
...
IS 
    ...
    localidad4 INT;
BEGIN
    SELECT COUNT(*) INTO localidad1 FROM PRODUCTOR1 WHERE CODPR = NEW_CODPR;
    ...
    IF localidad1 > 0 THEN
        DELETE FROM PRODUCTOR1 WHERE CODPR = NEW_CODPR;

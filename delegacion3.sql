...
DROP TABLE PRODUCTOR3;
DROP TABLE EMPLEADO3;
DROP TABLE CLIENTE3;
DROP TABLE SUMINISTRO3;
DROP TABLE PEDIDO3;
DROP TABLE PIDEVINOA;
DROP TABLE VINO3;
DROP TABLE SUCURSAL3;
ALTER TABLE SUCURSAL3 DROP CONSTRAINT CE10;
...
CREATE TABLE VINO3(
    ...
    CODPR INT,
    CONSTRAINT CE1 FOREIGN KEY (CODPR) REFERENCES PRODUCTOR3(CODPR)
);
...
CREATE TABLE EMPLEADO3(
    ...
    DIRECCION VARCHAR(30),
    CONSTRAINT CE2 FOREIGN KEY (CODSU) REFERENCES SUCURSAL3(CODSU)
);
...
CREATE TABLE PEDIDO3(
    CODVIN INT,
    CODSU INT,
    CANTIDAD INT,
    CONSTRAINT CE5 FOREIGN KEY (CODVIN) REFERENCES VINO3(CODVIN),
    CONSTRAINT CE6 FOREIGN KEY (CODSU) REFERENCES SUCURSAL3(CODSU)
);
...
CREATE TABLE SUMINISTRO3(
    ...
    CONSTRAINT CE4 FOREIGN KEY (CODCL) REFERENCES CLIENTE3(CODCL),
    CONSTRAINT CE8 FOREIGN KEY (CODSU) REFERENCES SUCURSAL3(CODSU)
);
...
ALTER TABLE SUCURSAL3 ADD CONSTRAINT CE10 FOREIGN KEY (CODDIRECTOR) REFERENCES EMPLEADO3(CODEM);


GRANT SELECT, INSERT, DELETE, UPDATE ON SUCURSAL3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON PRODUCTOR3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON VINO3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON EMPLEADO3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON CLIENTE3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON PEDIDO3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON SUMINISTRO3 TO kdekilo1, kdekilo2, kdekilo4;
GRANT SELECT, INSERT, DELETE, UPDATE ON PIDEVINOA TO kdekilo1, kdekilo2, kdekilo4;
...
INSERT INTO SUCURSAL3 VALUES(10, 'Meigas', 'La Coruña', 'Galicia', NULL);
INSERT INTO SUCURSAL3 VALUES(11, 'La Concha', 'San Sebastian', 'País Vasco', NULL);
INSERT INTO SUCURSAL3 VALUES(12, 'Don Pelayo', 'Oviedo', 'Asturias', NULL);


INSERT INTO EMPLEADO3 VALUES(19, 10, '19191919S', 'Gabriel', TO_DATE('19-SEP-2014', 'DD-MON-YYYY'), 2000, 'Hercules 19, La Coruña');
INSERT INTO EMPLEADO3 VALUES(20, 10, '20202020T', 'Octavio', TO_DATE('20-OCT-2014', 'DD-MON-YYYY'), 1800, 'María Pita 45, La Coruña');
INSERT INTO EMPLEADO3 VALUES(21, 11, '21212121V', 'Cesar', TO_DATE('13-NOV-2015', 'DD-MON-YYYY'), 2000, 'Las Peñas 41, San Sebastian');
INSERT INTO EMPLEADO3 VALUES(22, 11, '23232323W', 'Julia', TO_DATE('24-MAR-2012', 'DD-MON-YYYY'), 1800, 'San Cristobal 5, San Sebastian');
INSERT INTO EMPLEADO3 VALUES(23, 12, '24242424X', 'Claudia', TO_DATE('13-FEB-2011', 'DD-MON-YYYY'), 2000, 'Santa Cruz 97, Oviedo');
INSERT INTO EMPLEADO3 VALUES(24, 12, '25252525Z', 'Mario', TO_DATE('23-ABR-2013', 'DD-MON-YYYY'), 1800, 'Naranco 21, Oviedo');

-- Actualizamos los directores de las sucursales
UPDATE SUCURSAL3 SET CODDIRECTOR=19 WHERE CODSU=10;
UPDATE SUCURSAL3 SET CODDIRECTOR=21 WHERE CODSU=11;
UPDATE SUCURSAL3 SET CODDIRECTOR=23 WHERE CODSU=12;


INSERT INTO VINO3 VALUES(7, 'Rias Baixas', 2019, 'Albariño', 9.5, 'Santa Compaña', 150, 150, 'Galicia', NULL);
INSERT INTO VINO3 VALUES(8, 'Rias Baixas', 2018, 'Albariño', 9, 'Santa Compaña', 100, 100, 'Galicia', NULL);
INSERT INTO VINO3 VALUES(15, 'Santa María', 2018, 'Tierra de Cangas', 10, 'Monte Astur', 200, 200, 'Asturias', NULL);
INSERT INTO VINO3 VALUES(19, 'Meigas Bellas', 2019, 'Ribeiro', 8.5, 'Mayor Santiago', 250, 250, 'Galicia', NULL);
INSERT INTO VINO3 VALUES(20, 'Altamira', 2019, 'Tierra de Liébana', 9.5, 'Cuevas', 300, 300, 'Cantabria', NULL);
 


INSERT INTO PRODUCTOR3 VALUES(1, '35353535A','Justiniano Briñon', 'Ramon y Cajal 9, Valladolid');
INSERT INTO PRODUCTOR3 VALUES(4, '38383838D','Amador Laguna', 'Juan Ramon Jimenez 17, Cordoba');
INSERT INTO PRODUCTOR3 VALUES(6, '40404040F','Carlota Fuentes', 'Cruz de los Angeles 29, Oviedo');


UPDATE VINO3 SET CODPR=4 WHERE CODVIN=7;
UPDATE VINO3 SET CODPR=4 WHERE CODVIN=8;
UPDATE VINO3 SET CODPR=6 WHERE CODVIN=15;
UPDATE VINO3 SET CODPR=6 WHERE CODVIN=19;
UPDATE VINO3 SET CODPR=1 WHERE CODVIN=20;



INSERT INTO CLIENTE3 VALUES(3, '28282828C', 'Continente', 'San Francisco 37, Vigo', 'A', 'Galicia');
INSERT INTO CLIENTE3 VALUES(4, '29292929D', 'El Asturiano', 'Covadonga 24, Luarca', 'C', 'Asturias');



INSERT INTO SUMINISTRO3 VALUES(3, 3, 10, 100, TO_DATE('21-FEB-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO3 VALUES(3, 6, 10, 90, TO_DATE('02-AGO-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO3 VALUES(3, 13, 11, 200, TO_DATE('03-OCT-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO3 VALUES(3, 20, 12, 150, TO_DATE('04-NOV-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO3 VALUES(4, 8, 12, 50, TO_DATE('01-MAR-2023', 'DD-MON-YYYY'));
INSERT INTO SUMINISTRO3 VALUES(4, 17, 12, 70, TO_DATE('03-MAY-2023', 'DD-MON-YYYY'));
...
BEFORE UPDATE OF SALARIO ON EMPLEADO3
FOR EACH ROW
BEGIN
...
BEFORE INSERT ON SUMINISTRO3
FOR EACH ROW
DECLARE
    ultimaFechaSuministro DATE;
BEGIN
    -- Obtener la fecha del último suministro para este cliente
    SELECT MAX(FECHASUMINISTRO) INTO ultimaFechaSuministro FROM SUMINISTRO3 WHERE CODCL = :NEW.CODCL;
...
BEGIN
    ...
    SELECT SUM(CANTIDAD) INTO totalSuministrado FROM SUMINISTRO3 WHERE CODVIN = :OLD.CODVIN;
...
BEGIN
    ...
    FROM VINO3 V
    JOIN SUMINISTRO3 S ON V.CODVIN = S.CODVIN
...
CREATE OR REPLACE PROCEDURE AltaNuevoEmpleado
    (NEW_CODEM INT, NEW_DNI IN EMPLEADO3.DNI%TYPE, NEW_NOMBRE IN EMPLEADO3.NOMBRE%TYPE, NEW_FECHACONTRATO DATE, NEW_SALARIO INT,
    NEW_DIRECCION IN EMPLEADO3.DIRECCION%TYPE, NEW_CODSU INT)
IS 
    nSucursales INT;
    nEmpleados INT;
    comAutSucursal SUCURSAL3.COMAUTONOMA%TYPE; 
BEGIN
    ...
    ELSE
        ...
        CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                INSERT INTO EMPLEADO3 VALUES(NEW_CODEM, NEW_CODSU, NEW_DNI, NEW_NOMBRE, NEW_FECHACONTRATO, NEW_SALARIO, NEW_DIRECCION);
...
BEGIN
    ...
    ELSE
        ...
        CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                DELETE FROM EMPLEADO3 WHERE CODEM=OLD_CODEM;
            WHEN (comAutSucursal = 'Andalucia' OR comAutSucursal = 'Extremadura' OR comAutSucursal = 'Canarias' OR comAutSucursal = 'Ceuta' OR comAutSucursal = 'Melilla') THEN
...
BEGIN
    ...
    ELSE
        ...
        CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                UPDATE EMPLEADO3 SET SALARIO = NEW_SALARIO WHERE CODEM = NEW_CODEM;
            WHEN (comAutSucursal = 'Andalucia' OR comAutSucursal = 'Extremadura' OR comAutSucursal = 'Canarias' OR comAutSucursal = 'Ceuta' OR comAutSucursal = 'Melilla') THEN
...
CREATE OR REPLACE PROCEDURE TrasladarEmpleadoSucursal
    (NEW_CODEM INT, NEW_CODSU INT, NEW_DIRECCION IN EMPLEADO3.DIRECCION%TYPE DEFAULT NULL)
IS 
    nEmpleados INT;
    nSucursal INT;
    comAutSucursal SUCURSAL3.COMAUTONOMA%TYPE; 
    FCONTRATO DATE;
    SUELDO INT;
    NEW_DNI EMPLEADO3.DNI%TYPE;
    NEW_NOMBRE EMPLEADO3.NOMBRE%TYPE;
BEGIN
    SELECT COUNT(*) INTO nEmpleados FROM EmpleadoView WHERE CODEM = NEW_CODEM;
...
CREATE OR REPLACE PROCEDURE AltaNuevaSucursal
    (NEW_CODSU IN SUCURSAL3.CODSU%TYPE, NEW_NOMBRE IN SUCURSAL3.NOMBRE%TYPE, NEW_CIUDAD IN SUCURSAL3.CIUDAD%TYPE, NEW_COMAUTONOMA IN SUCURSAL3.COMAUTONOMA%TYPE,
    ...
    ELSE
        CASE
            ...
            WHEN (NEW_COMAUTONOMA = 'Galicia' OR NEW_COMAUTONOMA = 'Asturias' OR NEW_COMAUTONOMA = 'Cantabria' OR NEW_COMAUTONOMA = 'Pais Vasco' OR NEW_COMAUTONOMA = 'Navarra') THEN
                INSERT INTO SUCURSAL3 VALUES(NEW_CODSU, NEW_NOMBRE, NEW_CIUDAD, NEW_COMAUTONOMA, NEW_CODDIRECTOR);
...
BEGIN
    ...
    ELSE        
        ...
        CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                UPDATE SUCURSAL3 SET CODDIRECTOR = NEW_CODDIRECTOR WHERE CODSU = NEW_CODSU;
            WHEN (comAutSucursal = 'Andalucia' OR comAutSucursal = 'Extremadura' OR comAutSucursal = 'Canarias' OR comAutSucursal = 'Ceuta' OR comAutSucursal = 'Melilla') THEN
...
CREATE OR REPLACE PROCEDURE AltaNuevoCliente
    (NEW_CODCL INT, NEW_DNI IN CLIENTE3.DNI%TYPE, NEW_NOMBRE IN CLIENTE3.NOMBRE%TYPE, NEW_DIRECCION IN CLIENTE3.DIRECCION%TYPE,
    NEW_TIPO IN CLIENTE3.TIPO%TYPE, NEW_COMAUTONOMA IN CLIENTE3.COMAUTONOMA%TYPE)
IS 
    nCliente INT;
BEGIN
    ...
    ELSE
        CASE
            ...
            WHEN (NEW_COMAUTONOMA = 'Galicia' OR NEW_COMAUTONOMA = 'Asturias' OR NEW_COMAUTONOMA = 'Cantabria' OR NEW_COMAUTONOMA = 'Pais Vasco' OR NEW_COMAUTONOMA = 'Navarra') THEN
                INSERT INTO CLIENTE3 VALUES(NEW_CODCL, NEW_DNI, NEW_NOMBRE, NEW_DIRECCION, NEW_TIPO, NEW_COMAUTONOMA);
            WHEN (NEW_COMAUTONOMA = 'Andalucia' OR NEW_COMAUTONOMA = 'Extremadura' OR NEW_COMAUTONOMA = 'Canarias' OR NEW_COMAUTONOMA = 'Ceuta' OR NEW_COMAUTONOMA = 'Melilla') THEN
...
BEGIN
    ...
    IF nSuministros > 0 THEN -- hay que actualizar el suministro
         CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                UPDATE SUMINISTRO3 SET CANTIDAD = CANTIDAD + NEW_CANTIDAD WHERE CODCL = NEW_CODCL AND CODVIN = NEW_CODVIN AND CODSU = NEW_CODSU AND FECHASUMINISTRO = NEW_FECHA;
            WHEN (comAutSucursal = 'Andalucia' OR comAutSucursal = 'Extremadura' OR comAutSucursal = 'Canarias' OR comAutSucursal = 'Ceuta' OR comAutSucursal = 'Melilla') THEN
    ...
    ELSE -- hay que crear el suministro
        CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                INSERT INTO SUMINISTRO3 VALUES(NEW_CODCL, NEW_CODVIN, NEW_CODSU, NEW_CANTIDAD, NEW_FECHA);
            WHEN (comAutSucursal = 'Andalucia' OR comAutSucursal = 'Extremadura' OR comAutSucursal = 'Canarias' OR comAutSucursal = 'Ceuta' OR comAutSucursal = 'Melilla') THEN
...
BEGIN
    ...
    ELSE 
        CASE
            ...
            WHEN (comAutSucursal = 'Galicia' OR comAutSucursal = 'Asturias' OR comAutSucursal = 'Cantabria' OR comAutSucursal = 'Pais Vasco' OR comAutSucursal = 'Navarra') THEN
                DELETE FROM SUMINISTRO3 WHERE CODCL = NEW_CODCL AND CODVIN = NEW_CODVIN AND CODSU = NEW_CODSU AND (NEW_FECHA IS NULL OR FECHASUMINISTRO = NEW_FECHA);
            WHEN (comAutSucursal = 'Andalucia' OR comAutSucursal = 'Extremadura' OR comAutSucursal = 'Canarias' OR comAutSucursal = 'Ceuta' OR comAutSucursal = 'Melilla') THEN
...
CREATE OR REPLACE PROCEDURE AltaNuevoVino
    (NEW_CODVIN INT, NEW_MARCA IN VINO3.MARCA%TYPE, NEW_ANIOCOSECHA INT, NEW_DENOMINACION IN VINO3.DENOMINACION_ORIGEN%TYPE, NEW_GRADUACION IN VINO3.GRADUACION%TYPE,
    NEW_VINIEDO IN VINO3.VINIEDOPROCEDENCIA%TYPE, NEW_COMAUTONOMA IN VINO3.COMAUTONOMA%TYPE, NEW_CANTPRODUCIDA INT, NEW_CODPR INT)
IS 
    nVino INT;
BEGIN
    ...
    ELSE
        CASE
            ...
            WHEN (NEW_COMAUTONOMA = 'Galicia' OR NEW_COMAUTONOMA = 'Asturias' OR NEW_COMAUTONOMA = 'Cantabria' OR NEW_COMAUTONOMA = 'Pais Vasco' OR NEW_COMAUTONOMA = 'Navarra') THEN
                INSERT INTO VINO3 VALUES(NEW_CODVIN, NEW_MARCA, NEW_ANIOCOSECHA, NEW_DENOMINACION, NEW_GRADUACION, NEW_VINIEDO, NEW_CANTPRODUCIDA, 
                NEW_CANTPRODUCIDA, NEW_COMAUTONOMA, NEW_CODPR);
            WHEN (NEW_COMAUTONOMA = 'Andalucia' OR NEW_COMAUTONOMA = 'Extremadura' OR NEW_COMAUTONOMA = 'Canarias' OR NEW_COMAUTONOMA = 'Ceuta' OR NEW_COMAUTONOMA = 'Melilla') THEN
...
IS 
    nVino INT;
    comAutonomaVino VINO3.COMAUTONOMA%TYPE;
BEGIN
    SELECT COUNT(*) INTO nVino FROM VinoView WHERE CODVIN = NEW_CODVIN;
    ...
    ELSE
        CASE
            ...
            WHEN (comAutonomaVino = 'Galicia' OR comAutonomaVino = 'Asturias' OR comAutonomaVino = 'Cantabria' OR comAutonomaVino = 'Pais Vasco' OR comAutonomaVino = 'Navarra') THEN
                DELETE FROM VINO3 WHERE CODVIN = NEW_CODVIN;
...
CREATE OR REPLACE PROCEDURE AltaNuevoProductor
    (NEW_CODPR INT, NEW_DNI IN PRODUCTOR3.DNI%TYPE, NEW_NOMBRE IN PRODUCTOR3.NOMBRE%TYPE, NEW_DIRECCION IN PRODUCTOR3.DIRECCION%TYPE)
IS 
    nProductor INT;
BEGIN
    SELECT COUNT(*) INTO nProductor FROM PRODUCTOR3 WHERE CODPR = NEW_CODPR;
    ...
    ELSE
        ...
        INSERT INTO PRODUCTOR3 VALUES(NEW_CODPR, NEW_DNI, NEW_NOMBRE, NEW_DIRECCION);
...
BEGIN
    ...
    SELECT COUNT(*) INTO localidad3 FROM PRODUCTOR3 WHERE CODPR = NEW_CODPR;
    ...
    ELSIF localidad3 > 0 THEN
        DELETE FROM PRODUCTOR3 WHERE CODPR = NEW_CODPR;
